...
This is a a mod of a mod all credits go to Neuromancer for the original mod.

Added textures using the unicode tsalagi font and sound by a native speaker western dialect.

After you have created pages open command type in latin "/w tsalagi" and it puts the syllabary textures on the blocks "ᏣᎳᎩ"
